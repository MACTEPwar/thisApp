...
{
    public partial class zkt2 : Form
    {
        ...
        public zkt2(IntPtr FormHandle, TextBox textBox)
        {
        ...
        public void open()
        {
           ...
           MessageBox.Show("reader parameter, image width:" + mfpWidth + ", height:" + mfpHeight + ", dpi:" + mfpDpi + "\n");

            Thread captureThread = new Thread(new ThreadStart(DoCapture));
            captureThread.IsBackground = true;
            captureThread.Start();
            bIsTimeToDie = false;
           MessageBox.Show("Open succ\n");
        ...
        public void identify()
        {
            ...
            {
                bIdentify = true;
               MessageBox.Show("Please press your finger!\n");
            }
        }
